...
export default function VotePage() {
  ...
  // Si no está autenticado, mostrar el nuevo login profesional
  if (!isAuthenticated) {
    return (
                ...
                {isMinor && (
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-amber-300">Restricción Legal de Edad</h4>
                        <p className="text-amber-200 text-sm mt-1">
                          De acuerdo con la Ley Electoral Nacional N° 26859, solo los ciudadanos 
                          mayores de 18 años pueden ejercer el derecho al voto. 
          ...
          {selectedCandidate && (
            <>
              ...
              <div className="space-y-8 py-6">
                {/* Educación y Experiencia en grid */}
